...
btns[0].addEventListener("click", () => {
  if (
    acentos.test(texto_usuario.value) ||
    caracteresEspeciales.test(texto_usuario.value)
  ) {
    texto_usuario.innerHTML = "";
    alert("el texto ingresado no puede tener caracteres especiales ni acentos");
